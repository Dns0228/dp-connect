...
if(NOT CLIENT_APPLICATION_DISPLAY_NAME)
    set(CLIENT_APPLICATION_DISPLAY_NAME "DP Connect" CACHE STRING "User-visible application name")
endif()
if(NOT CLIENT_BRAND_NAME)
    set(CLIENT_BRAND_NAME "DP project" CACHE STRING "Brand and package vendor")
endif()
if(NOT CLIENT_SERVICE_NAME)
    set(CLIENT_SERVICE_NAME "DPConnect-service" CACHE STRING "Service executable name")
endif()
if(NOT CLIENT_ORGANIZATION_NAME)
    set(CLIENT_ORGANIZATION_NAME "DP project" CACHE STRING "QSettings organization name")
endif()
if(NOT CLIENT_APP_INSTANCE_NAME)
    set(CLIENT_APP_INSTANCE_NAME "DPConnectInstance" CACHE STRING "Single-instance local server name")
endif()
...
if(NOT DEFINED CLIENT_ENABLE_APP_UPDATES)
    set(CLIENT_ENABLE_APP_UPDATES 0 CACHE BOOL "Enable updates from a configured DP Connect release service")
endif()

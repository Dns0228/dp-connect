        ...
        collapsedStateContent: Item {
            ...
            ColumnLayout {
                ...
                WarningType {
                    ...
                    textString: qsTr("DP WG 2.0 is outdated and no longer supported. Continued use requires a fresh installation of the DP WG 3.1 container.")
                }

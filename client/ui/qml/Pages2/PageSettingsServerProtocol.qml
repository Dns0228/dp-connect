    ...
    ListViewType {
        ...
        header: ColumnLayout {
            ...
            WarningType {
                ...
                textString: qsTr("DP WG 2.0 is outdated and does not include the latest security improvements, but it will continue to work. Moving to DP WG 3.1 by deploying a new container on the server is recommended for stronger protocol security")
            }
        }

...
PageType {
    ...
    QtObject {
        ...
        readonly property string description: qsTr("DP Connect logs")
    ...
    QtObject {
        ...
        readonly property string description: qsTr("DP Connect-service logs")
        ...
        readonly property var exportLogsHandler: function() {
            ...
            fileName = SystemController.getFileName(qsTr("Save"),
                                                    qsTr("Logs files (*.log)"),
                                                    StandardPaths.standardLocations(StandardPaths.DocumentsLocation) + "/DPConnect-service",
                                                    true,
                                                    ".log")
            if (fileName !== "") {
                PageController.showBusyIndicator(true)

...
QString errorString(ErrorCode code) {
    ...
    case(ErrorCode::ServerPortAlreadyAllocatedError): errorMessage = QObject::tr("The selected server port is already in use. Choose another port in protocol settings or stop the conflicting service on the VPS."); break;
    ...
    case (ErrorCode::AmneziaServiceConnectionFailed): errorMessage = QObject::tr("DP Connect helper service error"); break;
    ...
    case (ErrorCode::LegacyApiV1NotSupportedError): errorMessage = QObject::tr("This legacy DP Connect subscription format is no longer supported"); break;
    ...
    case (ErrorCode::ApiSubscriptionExpiredError): errorMessage = QObject::tr("Your VPN subscription has expired.\n Please check your email for renewal instructions.\n If you haven't received an email, please contact our support."); break;

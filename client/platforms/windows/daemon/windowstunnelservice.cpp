...
#define TUNNEL_NAMED_PIPE \
  "\\\\."                 \
  "\\pipe\\ProtectedPrefix\\Administrators\\AmneziaWG\\DPConnect"
...
bool WindowsTunnelService::start(const QString& configData) {
  ...
  service = CreateService(scm, TUNNEL_SERVICE_NAME, L"DP Connect (tunnel)",
  ...
  SERVICE_DESCRIPTION sd = {
      (wchar_t*)L"Manages the DP Connect tunnel connection"};

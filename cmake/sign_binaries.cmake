...
if(WIN32)
	set(DP_CONNECT_PACKAGE_DIR "${CPACK_TEMPORARY_DIRECTORY}/packages/DPConnect/data")
    if(SIGNTOOL_SUBJECT_NAME)
        include(${CMAKE_CURRENT_LIST_DIR}/util/signtool.cmake)
        signtool_sign_files("${DP_CONNECT_PACKAGE_DIR}/*.exe" "${SIGNTOOL_SUBJECT_NAME}" "${SIGNTOOL_CERT_HAS_UI}")
		signtool_sign_files("${DP_CONNECT_PACKAGE_DIR}/*.dll" "${SIGNTOOL_SUBJECT_NAME}" "${SIGNTOOL_CERT_HAS_UI}")
    endif()
endif()
...
if(APPLE)
    ...
    list(FILTER client_exec INCLUDE REGEX [[DPConnect$]])
    set(service_exec ${execs})
    list(FILTER service_exec INCLUDE REGEX [[DPConnect-service$]])
    set(other_execs ${execs})
    list(FILTER other_execs EXCLUDE REGEX [[DPConnect$|DPConnect-service$]])

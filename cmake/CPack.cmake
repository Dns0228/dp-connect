...
if(WIN32)
    set(CPACK_PACKAGE_FILE_NAME "DPConnect_${AMNEZIAVPN_VERSION}_windows_x64")
elseif(APPLE AND NOT IOS AND NOT MACOS_NE)
    set(CPACK_PACKAGE_FILE_NAME "DPConnect_${AMNEZIAVPN_VERSION}_macos_x64")
elseif(LINUX AND NOT ANDROID)
    set(CPACK_PACKAGE_FILE_NAME "DPConnect_${AMNEZIAVPN_VERSION}_linux_x64")
endif()
set(CPACK_PACKAGE_INSTALL_DIRECTORY DPConnect)
set(CPACK_PACKAGE_EXECUTABLES       DPConnect "DP Connect")
...
set(CPACK_IFW_PACKAGE_NAME                          DPConnect)
set(CPACK_IFW_PACKAGE_TITLE                         "DP Connect")
set(CPACK_IFW_PACKAGE_LOGO                          ${CMAKE_SOURCE_DIR}/client/images/dp-connect.png)
if(WIN32)
    set(CPACK_IFW_PACKAGE_WINDOW_ICON               ${CMAKE_SOURCE_DIR}/client/images/dp-connect.ico)
endif()
...
set(CPACK_WIX_UPGRADE_GUID          "{57079E3D-B841-4E7A-A897-0C81F164916D}")
set(CPACK_WIX_PRODUCT_ICON          ${CMAKE_SOURCE_DIR}/client/images/dp-connect.ico)
...
cpack_add_component(Uninstall
    DISPLAY_NAME "Uninstall DP Connect"
    REQUIRES_ADMIN_RIGHTS
    DISABLED
)
